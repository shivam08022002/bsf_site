      ...
      <div className="app-container">
        {showNotification && (
          <UserNotificationPopup
            ...
            closeAgentNotificationPopup={closeAgentNotificationPopup}
          />
        )}
        ...
        <Routes>
          ...
          <Route path="/bethistory" element={<ProtectedRoute><Statement /></ProtectedRoute>} />
          <Route path="/passwordhistory" element={<ProtectedRoute><Statement /></ProtectedRoute>} />
